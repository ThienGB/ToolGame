...
class AutoClickerInstance:
    ...
    def run(self, accounts, modes, shared_data):
        ...
        login_script = [
            ...
            {"action": "click_image_if", "target": "images_cs187/batdau1.png", "timeout": 4, "confidence": 0.85},
        ...
        tutorial_script = [
            {"action": "click_coords", "x": 23, "y": 243, "timeout": 2},
            {"action": "click_image_if", "target1": "images_cs187/x.png", "target2": "images_cs187/x1.png", "timeout": 120, "confidence": 0.85},
            {"action": "click_image_if", "target1": "images_cs187/x.png", "target2": "images_cs187/x1.png", "timeout": 5, "confidence": 0.85},
            ...
            {"action": "click_coords", "x": 1105, "y": 989, "timeout": 2},
            ...
            {"action": "click_coords", "x": 964, "y": 896, "timeout": 7},# chấp nhận
            {"action": "click_coords", "x": 770, "y": 965, "timeout": 4},
            {"action": "click_coords", "x": 770, "y": 965, "timeout": 2},
            {"action": "click_coords", "x": 770, "y": 965, "timeout": 2},
            # qh
            {"action": "click_image", "target": "images_cs187/hoanthanh.png", "timeout": 30, "confidence": 0.8},
            {"action": "click_image", "target1": "images_cs187/back.png", "target2": "images_cs187/back1.png","timeout": 30, "confidence": 0.8},
            ...
            {"action": "click_coords", "x": 1177, "y": 343, "timeout": 1},
            {"action": "click_image", "target": "images_cs187/99.png", "timeout": 30, "confidence": 0.8},
            {"action": "wait", "timeout": 3},
            {"action": "click_image", "target": "images_cs187/99.png", "timeout": 30, "confidence": 0.8},
            {"action": "click_coords", "x": 1153, "y": 981, "timeout": 3},
        ...
        dinh_game_script = [
            ...
            {"action": "click_image_if", "target": "images_boxphone/any2.png", "timeout": 200, "confidence": 0.7},
        ...
        shared_battle_script = [
            ...
            {"action": "wait", "timeout": 3},
            {"action": "click_image_if", "target1": "images_boxphone/sansang.png","target2": "images_boxphone/sansang1.png","target3": "images_boxphone/sansang2.png", "target4": "images_boxphone/da_san_sang.png" ,"target5": "images_boxphone/sansang5v5.png", "timeout": 3, "confidence": 0.7},
            ...
            # {"action": "click_image_if", "target": "images_boxphone/open.png", "timeout": 60, "confidence": 0.7},
            # {"action": "click_coords", "x": my_hero_pos["x"], "y": my_hero_pos["y"], "timeout": 2},
            {"action": "click_coords", "x": 1855, "y": 707, "timeout": 3},
            {"action": "click_image_if", "target": "images_boxphone/ok1.png", "timeout": 20, "confidence": 0.7},
            
            
            {"action": "click_image_if", "target": "images_boxphone/any2.png", "timeout": 600, "confidence": 0.7},
            {
                "action": "loop",
                "count": 12,
                "steps": [
        ...
        uplevel_script = [
            ...
            {"action": "click_image", "target1": "images_cs187/dang_xuat.png", "target2": "images_cs187/loguot.png", "timeout": 30, "confidence": 0.7},
            {"action": "click_image", "target": "images_cs187/ok1.png", "timeout": 30, "confidence": 0.7},
        ...
        new_circle_script = [
            ...
            {"action": "open_game"},
            # {"action": "click_image_if", "target1": "images_boxphone/xacnhan.png", "target2": "images_boxphone/xacnhan.jpg", "timeout": 37, "confidence": 0.7},
            ...
            {"action": "click_image_if", "target1": "images_boxphone/batdau.png", "target2": "images_boxphone/batdau1.png", "target3": "images_boxphone/batdauu.jpg",  "timeout": 13, "confidence": 0.7},
            ...
            # {"action": "click_coords", "x": 1742, "y": 1017, "timeout": 6},
            {
                ...
                "cases": [
                     {
                        "trigger1": "images_boxphone/napdau.png",
                        "trigger2": "images_boxphone/nhiemvu.png",
                        "confidence": 0.7,
                        "script": [
                            {"action": "press_esc", "wait": 2},
                            {"action": "press_esc", "wait": 2},
                    ...
                    {
                        "trigger": "images_boxphone/athur.png",
                        "confidence": 0.7,
                        "script": [
                            {"action": "click_image", "target": "images_boxphone/athur.png", "timeout": 30, "confidence": 0.7},
                            {"action": "click_image_if", "target": "images_boxphone/athur.png", "timeout": 3, "confidence": 0.7},
                    ...
                    {
                        "trigger1": "images_boxphone/sukien.png",
                        "trigger2": "images_boxphone/sukien1.png",
                        
                        "confidence": 0.7,
                        "script": [
                            {"action": "click_image_if", "target1": "images_boxphone/sukien.png","target2": "images_boxphone/sukien1.png", "timeout": 5, "confidence": 0.9},
                            
                            
                            {"action": "click_coords", "x": 1557, "y": 481, "timeout": 3},
                            {"action": "press_esc", "wait": 3},
                            {"action": "press_esc", "wait": 3},
                            {"action": "press_esc", "wait": 3},
                    ...
                    {
                        "trigger": "images_boxphone/tieptucchien.png" ,
                        "confidence": 0.7,
                         "script": [
                    ...
                    },
                    {
                        ...
                        "confidence": 0.7,
                         "script": [
                            {"action": "click_image_if", "target": "images_boxphone/co.png", "timeout": 5, "confidence": 0.9},
                            {"action": "click_image_if", "target1": "images_boxphone/sukien.png","target2": "images_boxphone/sukien1.png", "timeout": 5, "confidence": 0.9},
                            {"action": "click_coords", "x": 1557, "y": 481, "timeout": 3},
                            {"action": "press_esc", "wait": 3},
                            {"action": "press_esc", "wait": 3},
...
class MultiPremiumApp(ctk.CTk):
    ...
    def setup_layout(self):
        ...
        self.mode_dinh_game = ctk.CTkCheckBox(self.mode_frame, text="DÍNH GAME"); self.mode_dinh_game.grid(row=0, column=3); self.mode_dinh_game.deselect()
        self.mode_teamup = ctk.CTkCheckBox(self.mode_frame, text="GHÉP ĐỘI"); self.mode_teamup.grid(row=0, column=4); self.mode_teamup.deselect()
