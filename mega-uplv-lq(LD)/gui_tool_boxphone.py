...
class AutoClickerInstance:
    ...
    def run(self, accounts, modes, shared_data):
        ...
        login_script = [
            ...
            {"action": "click_image_if", "target1": "images_boxphone/input_name.png", "target2": "images_boxphone/input_name1.png", "timeout": 60, "confidence": 0.7},
            ...
            {"action": "click_image_if", "target1": "images_boxphone/ok2.png", "target2": "images_boxphone/ok_dang_nhap.jpg", "timeout": 4, "confidence": 0.7},
        ...
        tutorial_script = [
            {
                ...
                "cases": [
                    {
                        "trigger": "images_boxphone/vao_tran_button_1.png",
                        "confidence": 0.7,
                        "script": [
                            {"action": "click_image_if", "target": "images_boxphone/batdau.png", "timeout": 3, "confidence": 0.7},
                            {"action": "click_image_if", "target": "images_boxphone/vao_tran_button_1.png", "timeout": 3, "confidence": 0.7},
                            {"action": "wait", "timeout": 5},
                            {"action": "click_image_if", "target1": "images_boxphone/vao_tran_button_2.png", "target2": "images_boxphone/vao_tran_button_3.jpg", "target3": "images_boxphone/vao_tran_button_2.jpg","target4": "images_boxphone/vao_tran_box.png", "timeout": 30, "confidence": 0.7},
                            {"action": "click_image_if", "target1": "images_boxphone/vao_tran_button_2.png", "target2": "images_boxphone/vao_tran_button_3.jpg", "target3": "images_boxphone/vao_tran_button_2.jpg","target4": "images_boxphone/vao_tran_box.png", "timeout": 4, "confidence": 0.7}
                        ]
                    },
                    {
        ...
        # 2. GIAI ĐOẠN VƯỢT TÂN THỦ (Full chi tiết từ LD)
            ...
            {"action": "click_image_if", "target": "images_boxphone/close.png", "timeout": 5, "confidence": 0.7},
            ...
            {"action": "click_image", "target1": "images_boxphone/minimize.png", "target2": "images_boxphone/minimize1.jpg", "target3": "images_boxphone/minimize2.jpg", "target4": "images_boxphone/minimize3.jpg", "timeout": 20, "confidence": 0.7},
            {"action": "click_image", "target": "images_boxphone/ready.png", "timeout": 20, "confidence": 0.7},
            {"action": "click_image_if", "target": "images_boxphone/ok.png", "timeout": 3, "confidence": 0.7},
            {"action": "click_image_if", "target": "images_boxphone/ready.png", "timeout": 3, "confidence": 0.7},
            {"action": "click_image", "target1": "images_boxphone/tuong5.png",  "timeout": 20, "confidence": 0.7},
            {"action": "click_image", "target": "images_boxphone/ok.png", "timeout": 20, "confidence": 0.7},
            ...
            {"action": "click_image_if", "target": "images_boxphone/close.png", "timeout": 10, "confidence": 0.7},
            {"action": "wait", "timeout": 5},
            ...
            {"action": "wait", "timeout": 5},
            {"action": "click_image", "target": "images_boxphone/lobby.png", "timeout": 20, "confidence": 0.7},
            {"action": "wait", "timeout": 3},
            {"action": "press_esc", "wait": 2},
            {"action": "click_image", "target": "images_boxphone/nhan_sktt.png", "timeout": 60, "confidence": 0.7},
            {"action": "click_image_if", "target": "images_boxphone/nhan_sktt.png", "timeout": 5, "confidence": 0.7},
            {"action": "click_image", "target1": "images_boxphone/krixi.png", "target2": "images_boxphone/krixi_no_download.jpg", "timeout": 10, "confidence": 0.7},
            {"action": "click_any", "wait": 2},
            {"action": "click_any", "wait": 2},
            
            {"action": "click_image_if", "target1": "images_boxphone/lam_event.png", "target2": "images_boxphone/lam_box.png", "timeout": 10, "confidence": 0.7},
            {"action": "press_esc", "wait": 2} ,
            
            
            
            
            {"action": "click_image", "target": "images_boxphone/event_default.png", "timeout": 20, "confidence": 0.7},
            {"action": "press_esc", "wait": 2} ,
           
            
            {"action": "click_image", "target": "images_boxphone/event_default.png", "timeout": 20, "confidence": 0.7},
            {"action": "press_esc", "wait": 3} ,
            {"action": "click_image_if", "target": "images_boxphone/dau_hang_button.png", "timeout": 15, "confidence": 0.7},
